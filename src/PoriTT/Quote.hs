...
quoteElim u s (VFlx m sp)   = quoteSpine (unfoldSp u) s (pure (Met m (emptyQruning s))) sp
...
quoteNeut u s (VNFlx m sp)   = quoteSpine (unfoldSp u) s (pure (Met m (emptyQruning s))) sp
